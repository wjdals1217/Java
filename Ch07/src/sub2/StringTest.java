...
public class StringTest {
	public static void main(String[] args) {
		...
		// 문자열 비교
		if(str1 == str2) {  // 주소값을 비교하는 것
			 System.out.println("str1, str2 주소가 같다.");
		}else {
			System.out.println("str1, str2 주소가 다르다.");
		}
		
		if(str1.equals(str2)) { // 문자열을 비교(str1과 str2에서 재정의한 것)
		...
		System.out.println("sub1 : "+msg.substring(0, 5));
		System.out.println("sub2 : "+msg.substring(6));
		
		// 문자열 인덱스
		int idx1 = msg.indexOf("e"); // 앞에서부터 찾음
		int idx2 = msg.lastIndexOf("e"); // 뒤에서부터 찾음
		
		System.out.println("idx1 : " + idx1);
		System.out.println("idx2 : " + idx2);
		System.out.println("idx1 : " +msg.indexOf("e"));
		System.out.println("idx1 : " +msg.lastIndexOf("e"));
		...
		System.out.println("rs1 : "+msg.replace("Korea", "Busan"));
		System.out.println("rs2 : "+msg.replace("Hello", "Welcome"));
		...
		System.out.println("s1 : "+String.valueOf(var1));
		System.out.println("s2 : "+String.valueOf(var2));
		System.out.println("s3 : "+(""+ var3)); //괄호 없음 안됨
	}
}
