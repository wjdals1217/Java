...
public class RegularExpressionTest {
	...
	public static void main(String[] args) {
		...
		// 정규표현식
		String strPatt = "a[a-z]*"; //a로 시작하고 영어 소문자

		boolean r1 = Pattern.matches(strPatt, "apple"); //True
		boolean r2 = Pattern.matches(strPatt, "banana"); //False
		...
		String ptt2 = "^[가-힣]*$"; // 한글(이름 확인)
		String ptt3 = "(01\\d{1})-(\\d{3,4})-(\\d{4})"; // 휴대전화번호
