...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		boolean res1 = (var3 > 3) && (var4 > 3); //and(a도 true(1), b도 true(1))
		boolean res2 = (var3 > 2) && (var4 > 3);
		boolean res3 = (var3 > 3) || (var4 > 3); //or(a가 false(0), b가 false(0)일 때만 false(0))
		boolean res4 = (var3 > 3) || (var4 > 5); 
		boolean res5 = !(var3 > var4); //!뒤에 값을 부정함(따라서 false에서 true로 바뀜)
		...
		System.out.println("res4 : " + res4); //var3은 3보다 크거나 var4는 3보다 작다.
		System.out.println("res5 : " + res5); //var3은 var4는 크지 않다.
